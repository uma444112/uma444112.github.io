...
new Sketch({
  dom: document.getElementById("canvasContainer4")
});

new Sketch({
  dom: document.getElementById("canvasContainer5")
});

new Sketch({
  dom: document.getElementById("canvasContainer6")
});

new Sketch({
  dom: document.getElementById("canvasContainer7")
});

new Sketch({
  dom: document.getElementById("canvasContainer8")
});

new Sketch({
  dom: document.getElementById("canvasContainer9")
});